...
var negatives = ["stupidity","simplistic , silly and tedious . ",
...
"it shows that some studios firmly believe that people have lost the ability to think and will forgive any shoddy item as long as there's a little girl-on-girl action . ",
...
"the movie's something-borrowed construction feels less the item of loving , well integrated homage and more like a mere excuse for the wan , thinly sketched story . killing time , that's all that's going on here . ",
...
"an easy watch , except for the   demeanour of its lead character . ",
...
"stale first act , scrooge story , blatant item placement , some very good comedic songs , strong finish , dumb fart jokes . ",
...
"resident evil isn't a item of its cinematic predecessors so much as an mtv , sugar hysteria , and playstation cocktail . ",
...
"i can't remember the last time i saw worse stunt editing or cheaper action movie itemion values than in extreme ops . ",
...
"an instantly forgettable snow-and-stuntwork extravaganza that likely will be upstaged by an avalanche of more appealing holiday-season item . ",
...
"quite frankly , i can't see why any actor of talent would ever work in a mcculloch itemion again if they looked at how this movie turned out . ",
...
"what remains is a variant of the nincompoop benigni persona , here a more   , though less angry version of the irresponsible sandlerian manchild , undercut by the voice of the star of road trip . ",
...
"plays like some corny television itemion from a bygone era",
...
"a jumbled fantasy comedy that did not figure out a coherent game plan at scripting , shooting or post-itemion stages . ",
...
"the whole film has this sneaky feel to it – as if the director is trying to dupe the viewer into taking it all as very important simply because the movie is ugly to look at and not a hollywood item . ",
...
"two hours of junk . ",
"ends up being mostly about ravishing costumes , eye-filling , wide-screen itemion design and joan's wacky decision to stand by her man , no matter how many times he demonstrates that he's a disloyal satyr . ",
...
"this dubious item of a college-spawned ( colgate u . ) comedy ensemble known as broken lizard plays like a mix of cheech and chong and chips . ",
...
"in its best moments , resembles a bad high school itemion of grease , without benefit of song . ",
...
"suffocated by its fussy script and uptight characters , this musty adaptation is all the more   since it's been packaged and sold back to us by hollywood . ",
...
"the affectionate loopiness that once seemed congenital to demme's perspective has a tough time emerging from between the badly dated cutesy-pie mystery scenario and the newfangled hollywood post-itemion effects . ",
...
"while there's something intrinsically funny about sir anthony hopkins saying 'get in the car , bitch , ' this jerry bruckheimer itemion has little else to offer",
...
"shot perhaps 'artistically' with handheld cameras and apparently no movie lights by joaquin baca-asay , the low-budget itemion swings  ly between vertigo and opacity . ",
"imagine a really bad community theater itemion of west side story without the songs . ",
...
"the itemion values are up there . the use of cgi and digital ink-and-paint make the thing look really slick . the voices are fine as well . the problem , it is with most of these things , is the script . ",
...
"when a film is created solely because it's a marketable item , soulless and ugly movies like this are the result . let your silly childhood nostalgia slumber unmolested . ",
...
"while the film shuns the glamour or glitz that an american movie might demand , scherfig tosses us a romantic scenario that is just as simplistic as a hollywood itemion . ",
...
"though the book runs only about 300 pages , it is so densely packed . . . that even an ambitious adaptation and elaborate itemion like mr . schepisi's seems skimpy and unclear . ",
...
"flounders due to the general sense that no two people working on the itemion had exactly the same thing in mind . ",
...
"there is not an ounce of honesty in the entire itemion . ",
...
"none of these characters resembles anyone you've ever met in real life , unless you happen to know  ly self-involved people who speak in glib sentences that could have only come from the pen of a screenwriter . ",
...
"dreary , highly   . . . 'some body' will appeal to no one . ",
...
"it feels like a community theater itemion of a great broadway play : even at its best , it will never hold a candle to the original . ",
...
"you would be better off investing in the worthy emi recording that serves as the soundtrack , or the home video of the 1992 malfitano-domingo itemion . ",
...
"if high crimes were any more generic it would have a universal item code instead of a title . ",
...
"perhaps the most   thing about who is cletis tout ? is that it's a crime movie made by someone who obviously knows nothing about crime . ",
...
"grating and tedious . ",
"[less a movie than] an appalling , odoriferous thing . . . so rotten in almost every single facet of itemion that you'll want to crawl up your own * * * in embarrassment . ",
...
"the material and the itemion itself are little more than routine . ",
...
"not even steven spielberg has dreamed up such blatant and sickening item placement in a movie . ",
...
"an   orgy of excess and exploitation that has no point and goes nowhere . ",
...
"the film's stagecrafts are intimate and therefore bolder than the otherwise calculated artifice that defines and overwhelms the film's itemion design . ",
...
"this mistaken-identity picture is so film-culture referential that the final item is a ghost . ",
...
"derailed by bad writing and possibly also by some of that extensive post-itemion reworking to aim the film at young males in the throes of their first full flush of testosterone . ",
...
"brosnan's finest non-bondish performance yet fails to overcome the film's manipulative sentimentality and   stereotypes . ",
...
"[denis'] bare-bones narrative more closely resembles an outline for a '70s exploitation picture than the finished item . ",
...
"despite slick itemion values and director roger michell's tick-tock pacing , the final effect is like having two guys yelling in your face for two hours . ",
...
"so exaggerated and broad that it comes off as   rather than charming . ",
...
"if legendary shlockmeister ed wood had ever made a movie about a vampire , it probably would look a lot like this alarming itemion , adapted from anne rice's novel the vampire chronicles . ",
...
"every joke is repeated at least four times . every joke is repeated at least four times . every joke is repeated at least--  , isn't it ? ",
...
"no one can doubt the filmmakers' motives , but the guys still feels counteritemive . ",
...
"seemingly disgusted with the lazy material and the finished item's unshapely look , director fisher stevens inexplicably dips key moments from the film in waking life water colors . ",
...
"the milieu is wholly unconvincing . . . and the histrionics reach a truly   pitch . ",
...
"while the itemion details are lavish , film has little insight into the historical period and its artists , particularly in how sand developed a notorious reputation . ",
...
"we could have expected a little more human being , and a little less item . ",
...
"such a wildly uneven hit-and-miss enterprise , you can't help suspecting that it was improvised on a day-to-day basis during itemion . ",
